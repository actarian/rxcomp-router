...
[RxComp Router](https://github.com/actarian/rxcomp-router) module for [RxComp](https://github.com/actarian/rxcomp), developed with [RxJs](https://github.com/ReactiveX/rxjs).
 ...
 lib & dependancy    | size
:--------------------|:----------------------------------------------------------------------------------------------|
rxcomp-router.min.js   | ![](https://img.badgesize.io/https://unpkg.com/rxcomp-router@1.0.0-beta.16/dist/umd/rxcomp-router.min.js.svg?compression=gzip)
rxcomp-router.min.js   | ![](https://img.badgesize.io/https://unpkg.com/rxcomp-router@1.0.0-beta.16/dist/umd/rxcomp-router.min.js.svg)
...
<script src="https://unpkg.com/rxcomp-router@1.0.0-beta.16/dist/umd/rxcomp-router.min.js" crossorigin="anonymous" SameSite="none Secure"></script>  
```
