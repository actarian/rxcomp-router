...
export { IBaseRoute, INavigationExtras, IRoute, IRoutes, Route, Routes, serializeUrl_ } from './route/route';
...
export { Data, Params, RouteComponent, RouterActivator, RouterActivatorResult, RouterKeyValue, RouterLink } from './router.types';
